...
export default function Setup() {
  ...
  const confirmFinish = () => {
    ...
    Alert.alert(
      'Finish setup now?',
      `${progress.total - progress.done} step${progress.total - progress.done === 1 ? ' is' : 's are'} still open. The checklist leaves Home; every step stays under Manage → Society settings.`,
      [
